...
/**
 * Created by cubc-luntan 2017/1/3.
 */
@Controller
...
//        }
//        weibo_alias = "观点";
        WeiboCommentServiceImpl.weiboAlias="微博";
        if(Integer.parseInt(weibo_post_maxcontent) > 500){
            return new ResponseModel(-1,WeiboCommentServiceImpl.weiboAlias+"最大字数不能超过500");
        }
        Map<String,String> params = new HashMap<>();

        params.put("weibo_alias",WeiboCommentServiceImpl.weiboAlias);

...
<head>
    ...
    <title>cubc-luntan后台管理系统登录 - ${SITE_NAME} - Powered By cubc-luntan</title>
...
<div class='login'>
    ...
    <div class='disclaimer'>
        <p>欢迎登陆cubc-luntan后台管理系统 <a href="../">返回首页</a></p>
        <p>Powered By <a href="http://www.cubc.deppon.com" target="_blank">cubc-luntan</a> CopyRight © 2012-2017</p>
    </div>
</div>
<div class='authent'>

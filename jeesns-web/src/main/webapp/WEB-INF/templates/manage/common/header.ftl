<header class="main-header">
    <a href="http://www.cubc.deppon.com" class="logo" target="_blank">
        <span class="logo-mini"><b>CLT</b></span>
        <span class="logo-lg"><b>cubc-luntan</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="${uploadCubcPath}${basePath}${loginUser.avatar}" class="user-image" alt="User Image">
                        <span class="hidden-xs">${loginUser.name}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="${uploadCubcPath}${basePath}${loginUser.avatar}" class="img-circle" alt="User Image">
                            <p>
                                ${loginUser.name}
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" module="system">
                ...
                <ul class="treeview-menu">
                    ...
                    <#--获取图片列表-->
                    <li><a href="${managePath}/system/action/manageBanner" module="system"><i class="fa fa-circle-o"></i>管理图片</a></li>
                </ul>
            </li>

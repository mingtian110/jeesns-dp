...
<head>
    ...
    <title>${group.name} - ${GROUP_ALIAS} - ${SITE_NAME} - Powered By cubc-luntan</title>
                        ...
                        <div class="fan">
                            <div class="avatar">
                                <a href="${basePath}/u/${groupFans.member.id}" target="_blank">
                                    <img class="img-circle" src="${uploadCubcPath}${basePath}${groupFans.member.avatar}" width="50px"
                                         height="50px"/>
                                </a>
                            </div>
                            <div class="name">

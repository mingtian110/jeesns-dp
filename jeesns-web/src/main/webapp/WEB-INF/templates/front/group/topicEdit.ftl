...
<head>
    ...
    <title>修改帖子 - ${SITE_NAME} - Powered By cubc-luntan</title>
            ...
            <div class="col-md-12 article-detail">
                <form class="form-horizontal jeesns_form" role="form" action="${basePath}/group/topicUpdate"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div id="uploader">
                                ...
                                <#if groupTopic.thumbnail?? && groupTopic.thumbnail!=''>
                                    <img src="${uploadCubcPath}${basePath}${groupTopic.thumbnail}" width="100px" height="100px"/>
                                </#if>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="description">${groupTopic.description}</textarea>
                        </div>
                    </div>
                    <div class="form-group">

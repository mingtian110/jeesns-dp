...
<head>
    ...
    <title>粉丝 - ${group.name} - ${GROUP_ALIAS} - ${SITE_NAME} - Powered By cubc-luntan</title>
                                ...
                                <div class="group-fans">
                                    <a href="${basePath}/u/${groupFans.member.id}" target="_blank">
                                        <div class="group-fans-avatar">
                                            <img class="img-circle" src="${uploadCubcPath}${basePath}${groupFans.member.avatar}" width="60px" height="60px"/>
                                        </div>

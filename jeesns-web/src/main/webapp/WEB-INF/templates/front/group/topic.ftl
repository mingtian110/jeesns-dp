...
<head>
    ...
    <title>${groupTopic.title} - ${groupTopic.group.name} - ${SITE_NAME} - Powered By cubc-luntan</title>
                        ...
                        <div class="reply-form">
                            <form class="form-horizontal jeesns_form"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" class="form-control new-comment-text" rows="2" placeholder="撰写评论..."></textarea>
                                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="group white-bg">
                    <div class="group-logo">
                        <img alt="${groupTopic.group.name}" src="${uploadCubcPath}${basePath}${groupTopic.group.logo}" width="80px"
                             height="80px"/>
                    </div>
                    ...
                    <div class="panel-body weibo-author">
                        <div class="avatar">
                            <a href="${basePath}/u/${groupTopic.member.id}" target="_blank">
                                <img alt="image" class="img-circle mg-l-30" src="${uploadCubcPath}${basePath}${groupTopic.member.avatar}"/></a>
                        </div>
                        <div class="name">

...
<head>
    ...
    <title>${member.name}主页 - ${SITE_NAME} - Powered By cubc-luntan</title>
    ...
    <div class="member-banner" style="background-image: url(${basePath}/res/common/images/member_banner.png);">
        ...
        <div class="container">
            <div class="container content">
                <div class="left">
                    <div class="avatar">
                        <img src="${uploadCubcPath}${basePath}${member.avatar}" class="img-circle" width="80px" height="80px"/>
                    </div>
                    <div class="info">
                        <div class="name">
                        ${member.name}
                                                    ...
                                                    <div class="text-center list-thumbnail">
                                                        <a href="${basePath}/article/detail/${article.id}" class="btn-link">
                                                            <img alt="${article.title}"
                                                                 ...
                                                                 src="${uploadCubcPath}${article.thumbnail}">
                                                        </a>
                                                    </div>
                                                </div>
                                            </#if>
                                                    ...
                                                    <div class="text-center list-thumbnail">
                                                        <a href="${basePath}/article/detail/${groupTopic.id}" class="btn-link">
                                                            <img alt="${groupTopic.title}"
                                                                 class="m-t-xs img-responsive list-thumbnail"
                                                                 src="${uploadCubcPath}${groupTopic.thumbnail}">
                                                        </a>
                                                    </div>
                                                </div>
                                            </#if>
                                    ...
                                    <#list model.data as weibo>
                                        <div class="feed-element">
                                            <a href="${basePath}/u/${weibo.member.id}" target="_blank" class="pull-left">
                                                <img alt="image" class="img-circle" src="${uploadCubcPath}${basePath}${weibo.member.avatar!''}">
                                            </a>
                                            <div class="media-body ">
                                                <strong>
                                                ...
                                                <div class="mg-t-10 mg-b-10">
                                                    ...
                                                    <div class="lightBoxGallery">
                                                        <#list weibo.pictures as picture>
                                                            <a href="${basePath}${picture.path}" title="${weibo.member.name}" data-gallery=""><img src="${uploadCubcPath}${basePath}${picture.thumbnailPath}"/></a>
                                                        </#list>
                                    ...
                                    <#list model.data as groupFans>
                                        <div class="feed-element">
                                            <a href="${basePath}/group/detail/${groupFans.group.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${uploadCubcPath}${groupFans.group.logo}">
                                            </a>
                                            <div class="media-body ">
                                    ...
                                    <#list model.data as memberFans>
                                        <div class="feed-element">
                                            <a href="${basePath}/u/${memberFans.followWhoMember.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${uploadCubcPath}${memberFans.followWhoMember.avatar}">
                                            </a>
                                            <div class="media-body ">
                                    ...
                                    <#list model.data as memberFans>
                                        <div class="feed-element">
                                            <a href="${basePath}/u/${memberFans.whoFollowMember.id}" class="pull-left">
                                                <img alt="image" class="img-circle" src="${uploadCubcPath}${memberFans.whoFollowMember.avatar}">
                                            </a>
                                            <div class="media-body ">

<nav class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header m-navbar-header">
            ...
            <#--<a class="navbar-brand jeesns-logo" href="${basePath}/"><img src="${uploadCubcPath}${basePath}${SITE_LOGO}" height="50px" style="border-radius:8px;"/></a>-->
        </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <#else>
                    <div class="btn-group nav-username">
                        ...
                        ${loginUser.name}
                            <#if unReadNoticeNum &gt; 0><i class="fa icon-bell " style="color: red;"></i>${unReadNoticeNum}</#if>
                        </a>
...
<script src="${basePath}/res/common/js/three.min.js"></script>
...
<div class="wuyou-waiter">
    <ul class="waiter-ul">
        ...
        <li class="wuyou-contact">
            <a class=" icon-qq" href="${basePath}/member/message?mid=5" target="_blank"></a>
            <div class="waiter-title">CUBC</div>
        </li>
        <li class="wuyou-game" id="3DGame">
            <a class=" icon-gamepad" href="${basePath}/res/TheAviator/index.html" target="_blank"></a>
            <div class="waiter-title">3D</div>
        </li>
        <li class="wuyou-calc">
            <a class=" icon-calculator" href="${basePath}/res/calc/index.html" target="_blank"></a>
            <div class="waiter-title">计算器</div>
        </li>
        <li class="wuyou-top">

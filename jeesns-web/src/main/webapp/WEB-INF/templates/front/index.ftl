...
<head>
    ...
    <title>${SITE_NAME} - ${SITE_SEO_TITLE} - Powered By cubc-luntan</title>
                                ...
                                <div class="col-md-4">
                                    <div class="item index-article">
                                        <div class="item-content">
                                            ...
                                            <#--<i class="icon-heart" style="color: red"></i> 喜欢 | ${groupTopic.favor}-->
                                        </div>
                                        <div class="item-footer">
                                            <a href="${basePath}/group/topic/${groupTopic.id}" class="text-muted"><i class="icon-eye-open" style="color: #00acd6"></i> ${groupTopic.viewCount}</a> &nbsp; <span class="text-muted">${groupTopic.createTime?string('yyyy-MM-dd HH:mm')} <i class="icon-heart" style="color: crimson"></i> ${groupTopic.favor}</span>
                                        </div>
                                    </div>
                                </div>
                            </#list>
                                ...
                                <div class="col-md-3">
                                    <div class="item index-article">
                                        <div class="item-content">
                                            ...
                                            <#--<i class="icon-heart" style="color: red"></i> 喜欢 | ${article.favor}-->
                                        </div>

                                        <div class="item-footer">
                                            <a href="${basePath}/article/detail/${article.id}" class="text-muted"><i class="icon-eye-open" style="color: #00acd6"></i> ${article.viewCount}</a> &nbsp; <span class="text-muted">${article.createTime?string('yyyy-MM-dd HH:mm')} <i class="icon-heart" style="color: crimson"></i> ${article.favor}</span>
                                        </div>
                                    </div>
                                </div>
                            </#list>
                                        ...
                                        <div class="group-detail">
                                            <div class="group-logo">
                                                <a href="${basePaht}/group/detail/${group.id}">
                                                    <img alt="image" class="img-rounded" src="${uploadCubcPath}${basePath}${group.logo}" width="100px" height="100px">
                                                </a>
                                            </div>

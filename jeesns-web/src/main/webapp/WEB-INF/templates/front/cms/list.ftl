...
<head>
    ...
    <title><#if articleCate??>${articleCate.name}<#else>文章列表</#if> - ${SITE_NAME} - Powered By cubc-luntan</title>
                    ...
                    <div class="item article-list shadow">
                        <div class="item-content">
                            ...
                            <div class="text">
                                ...
                                <p>
                                    <span class="text-muted"><i class="icon-eye-open" style="color: #00a7d0"></i> ${article.viewCount} &nbsp; <i class="icon-time"></i> ${article.createTime?string('yyyy-MM-dd HH:mm')} <i class="icon-heart" style="color: crimson"></i> ${article.favor}</span>
                                </p>
                            </div>
                        </div>
                    </div>

...
<head>
    ...
    <title>${weibo.member.name}${WEIBO_ALIAS} - ${SITE_NAME} - Powered By cubc-luntan</title>
            ...
            <div class="col-md-8">
                <article class="article weibo-detail">
                    <section class="content">
                        <div class="avatar">
                            <img alt="image" class="img-circle mg-l-30" src="${uploadCubcPath}${basePath}${weibo.member.avatar}"/>
                        </div>
                        <div class="name">
                        ${weibo.member.name}
                        </div>
                        ...
                        <#list weibo.pictures as picture>
                            <a href="${uploadCubcPath}${basePath}${picture.path}" title="${weibo.member.name}" data-gallery=""><img
                                    src="${uploadCubcPath}${basePath}${picture.thumbnailPath}"/></a>
                        </#list>

...
<head>
    ...
    <title>${WEIBO_ALIAS}中心 - ${SITE_NAME} - Powered By cubc-luntan</title>
                ...
                <#list model.data as weibo>
                    <div class="comment">
                        <a href="${basePath}/u/${weibo.member.id}" class="avatar" target="_blank">
                            <img src="${uploadCubcPath}${basePath}${weibo.member.avatar!''}" class="icon-camera-retro icon-2x">
                        </a>
                        <div class="content">
                            ...
                            <div class="text">
                                ...
                                <div class="lightBoxGallery">
                                    <#list weibo.pictures as picture>
                                        <a href="${uploadCubcPath}${basePath}${picture.path}" title="${weibo.member.name}"
                                           data-gallery=""><img src="${uploadCubcPath}${basePath}${picture.thumbnailPath}"/></a>
                                    </#list>
                            ...
                            <#else>
                                ...
                                <a href="${basePath}/weibo/detail/${weibo.id}">查看详情 评论:${weibo.commentCount}</a>)
                            </div>
                        </div>
                    </div>
                </#list>
                    ...
                    <div class="panel-body article-hot-list">
                        ...
                        <@wb_weibo_list sort='view-count' num=10 day=30; weibo>
                            <#list weiboList as weibo>
                                <div class="comment">
                                    <a href="${basePath}/u/${weibo.member.id}" class="avatar" target="_blank">
                                        <img src="${uploadCubcPath}${basePath}${weibo.member.avatar!''}"
